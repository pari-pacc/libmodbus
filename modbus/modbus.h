...
extern unsigned int const libmodbus_version_major;
extern unsigned int const libmodbus_version_minor;
extern unsigned int const libmodbus_version_micro;
...
MODBUS_API char const* modbus_strerror(int errnum);
...
MODBUS_API int modbus_write_bits(modbus_t* ctx, int addr, int nb, uint8_t const* data);
MODBUS_API int
modbus_write_registers(modbus_t* ctx, int addr, int nb, uint16_t const* data);
MODBUS_API int
modbus_mask_write_register(modbus_t* ctx, int addr, uint16_t and_mask, uint16_t or_mask);
MODBUS_API int modbus_write_and_read_registers(
  modbus_t* ctx,
  int write_addr,
  int write_nb,
  uint16_t const* src,
...
MODBUS_API modbus_mapping_t* modbus_mapping_new(
  int nb_bits,
  int nb_input_bits,
  int nb_registers,
  int nb_input_registers);
...
MODBUS_API int
modbus_send_raw_request(modbus_t* ctx, uint8_t const* raw_req, int raw_req_length);

MODBUS_API int modbus_receive(modbus_t* ctx, uint8_t* req);

MODBUS_API int modbus_receive_confirmation(modbus_t* ctx, uint8_t* rsp);

MODBUS_API int modbus_reply(
  modbus_t* ctx,
  uint8_t const* req,
  int req_length,
  modbus_mapping_t* mb_mapping);
MODBUS_API int
modbus_reply_exception(modbus_t* ctx, uint8_t const* req, unsigned int exception_code);
...
MODBUS_API void modbus_set_bits_from_bytes(
  uint8_t* dest,
  int idx,
  unsigned int nb_bits,
  uint8_t const* tab_byte);
MODBUS_API uint8_t
modbus_get_byte_from_bits(uint8_t const* src, int idx, unsigned int nb_bits);
MODBUS_API float modbus_get_float(uint16_t const* src);
MODBUS_API float modbus_get_float_abcd(uint16_t const* src);
MODBUS_API float modbus_get_float_dcba(uint16_t const* src);
MODBUS_API float modbus_get_float_badc(uint16_t const* src);
MODBUS_API float modbus_get_float_cdab(uint16_t const* src);
